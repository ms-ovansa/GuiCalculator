...
public class JavaCalculator {
    private double tottal1= 0.0;
    private double tottal2= 0.0;
    ...
    private void getOperator(String btnText){
        ...
        tottal1= tottal1+ Double.parseDouble(textField1.getText());
        textField1.setText("");
    }
        ...
        btnEqual.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                switch (math_operator){
                    case '+':
                        tottal2 = tottal1 + Double.parseDouble(textField1.getText());
                        break;
                    case '-':
                        tottal2 = tottal1 - Double.parseDouble(textField1.getText());
                        break;
                ...
                textField1.setText(Double.toString(tottal2));
                tottal1=0;
            }
        });
